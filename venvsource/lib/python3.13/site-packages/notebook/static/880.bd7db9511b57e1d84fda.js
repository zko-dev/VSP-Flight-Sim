...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40740);
...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(90945),
    __webpack_require__(3262),
    __webpack_require__(48174),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(13870),
  __webpack_require__(90311),
  __webpack_require__(90376),
  __webpack_require__(61369),
  __webpack_require__(18642),
  __webpack_require__(67804),
  __webpack_require__(70162),
  
      (__webpack_require__(57117)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(14237)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(69403),
  __webpack_require__(22616),
  
      (__webpack_require__(62069)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(71665)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(40191),
  
      (__webpack_require__(75515)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(19750)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(72591)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(37845)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(79277)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(67965),
  __webpack_require__(69524),
  __webpack_require__(13474),
  __webpack_require__(49752),
  
      (__webpack_require__(7248)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(42798),
  __webpack_require__(6102),
  __webpack_require__(60055),
  
      (__webpack_require__(94381)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(23926),
  __webpack_require__(24313),
  __webpack_require__(22777),
  __webpack_require__(74892),
  __webpack_require__(26158),
  __webpack_require__(55551),
  __webpack_require__(90984),
  __webpack_require__(90497),
  __webpack_require__(58962),
  __webpack_require__(18884),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(45106),
  
      (__webpack_require__(73241)["default"].filter)(({id}) => [
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(47480),
  __webpack_require__(25014),
  
      (__webpack_require__(51682)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:display-registry',
      ...
      __webpack_require__(54487),
  __webpack_require__(28563),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(88619)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(52911)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(56813).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(16777).IServiceManager);
...
//# sourceMappingURL=880.bd7db9511b57e1d84fda.js.map?v=bd7db9511b57e1d84fda